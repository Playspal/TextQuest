...
public class UiCardSimpleFront : MonoBehaviour
{
    ...
    public void SetButton1(string caption, Action callback)
    {
        _button1.SetCaption(caption);
        _buttonCallback1 = callback;
    }
    
    public void SetButton2(string caption, Action callback)
    {
        _button2.SetCaption(caption);
        _buttonCallback2 = callback;
    }
